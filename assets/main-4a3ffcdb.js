import{r as v,i as g,e as u,t as d,s as b,y as p,a as f,m as w,o as _}from"./ts-wave-b7644c6b.js";const O="https://api.github.com/users/trustedshops-public/repos?per_page=100&type=owner",$=e=>{const r=new Map;return e.forEach(s=>{const[o]=s.topics.filter(a=>a.startsWith("ts"));if(!o)return;const t=o.substring(2);r.has(t)?r.set(t,[...r.get(t),s]):r.set(t,[s])}),r};function y(e){return e.split("-").map(r=>`${r.charAt(0).toUpperCase()}${r.slice(1)}`).join(" ")}var P=Object.defineProperty,C=Object.getOwnPropertyDescriptor,m=(e,r,s,o)=>{for(var t=o>1?void 0:o?C(r,s):r,a=e.length-1,i;a>=0;a--)(i=e[a])&&(t=(o?i(r,s,t):i(t))||t);return o&&t&&P(r,s,t),t};let l=class extends b{constructor(){super(...arguments),this.repository="",this.repo={id:-1,name:"",html_url:"",description:"",created_at:"",updated_at:"",topics:[]}}connectedCallback(){super.connectedCallback(),this.repo=JSON.parse(this.repository),this.repo.name=y(this.repo.name)}render(){return p`
      <li class='card'>
    ...
    `];m([u()],l.prototype,"repository",2);m([d()],l.prototype,"repo",2);l=m([f("ts-card")],l);var j=Object.defineProperty,S=Object.getOwnPropertyDescriptor,h=(e,r,s,o)=>{for(var t=o>1?void 0:o?S(r,s):r,a=e.length-1,i;a>=0;a--)(i=e[a])&&(t=(o?i(r,s,t):i(t))||t);return o&&t&&j(r,s,t),t};let n=class extends b{constructor(){super(...arguments),this.list="",this.title="",this.repositories=[]}connectedCallback(){super.connectedCallback(),this.repositories=JSON.parse(this.list),this.title=y(JSON.parse(this.title))}render(){return p`
      <section>
        <h2>${this.title}</h2>
        <ul>
