 ...
 */const ne=window,ve=ne.ShadowRoot&&(ne.ShadyCSS===void 0||ne.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,_e=Symbol(),Re=new WeakMap;let Ge=class{constructor(e,t,n){if(this._$cssResult$=!0,n!==_e)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(ve&&e===void 0){const n=t!==void 0&&t.length===1;n&&(e=Re.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&Re.set(t,e))}return e}toString(){return this.cssText}};const dt=r=>new Ge(typeof r=="string"?r:r+"",void 0,_e),K=(r,...e)=>{const t=r.length===1?r[0]:e.reduce((n,i,s)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+r[s+1],r[0]);return new Ge(t,r,_e)},ft=(r,e)=>{ve?r.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const n=document.createElement("style"),i=ne.litNonce;i!==void 0&&n.setAttribute("nonce",i),n.textContent=t.cssText,r.appendChild(n)})},Oe=ve?r=>r:r=>r instanceof CSSStyleSheet?(e=>{let t="";for(const n of e.cssRules)t+=n.cssText;return dt(t)})(r):r;/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Et=(r,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,r)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,r)}},Ct=(r,e,t)=>{e.constructor.createProperty(t,r)};function Y(r){return(e,t)=>t!==void 0?Ct(r,e,t):Et(r,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;function ct(r){return r.split("-").map(e=>`${e.charAt(0).toUpperCase()}${e.slice(1)}`).join(" ")}var Xt=Object.defineProperty,Yt=Object.getOwnPropertyDescriptor,Se=(r,e,t,n)=>{for(var i=n>1?void 0:n?Yt(e,t):e,s=r.length-1,o;s>=0;s--)(o=r[s])&&(i=(n?o(e,t,i):o(i))||i);return n&&i&&Xt(e,t,i),i};let W=class extends z{constructor(){super(...arguments),this.repository="",this.repo={id:-1,name:"",html_url:"",description:"",created_at:"",updated_at:"",topics:[]}}connectedCallback(){super.connectedCallback(),this.repo=JSON.parse(this.repository),this.repo.name=ct(this.repo.name)}render(){return I`
      <li class='card'>
    ...
    `];Se([Y()],W.prototype,"repository",2);Se([ee()],W.prototype,"repo",2);W=Se([he("ts-card")],W);var en=Object.defineProperty,tn=Object.getOwnPropertyDescriptor,ce=(r,e,t,n)=>{for(var i=n>1?void 0:n?tn(e,t):e,s=r.length-1,o;s>=0;s--)(o=r[s])&&(i=(n?o(e,t,i):o(i))||i);return n&&i&&en(e,t,i),i};let Z=class extends z{constructor(){super(...arguments),this.list="",this.title="",this.repositories=[]}connectedCallback(){super.connectedCallback(),this.repositories=JSON.parse(this.list),this.title=ct(JSON.parse(this.title))}render(){return I`
      <section>
        <h2>${this.title}</h2>
        <ul>
          ${this.repositories.map(r=>I`
              <ts-card
...
Thank your for understanding. `)}}render(){return I`
      <main>
        ...
        ${Array.from(this.data).map(([r,e])=>I`
            <ts-section
  ...
  `;Ce([Y({type:String})],G.prototype,"direction",2);Ce([ee()],G.prototype,"device",2);G=Ce([he("ts-wave")],G);
